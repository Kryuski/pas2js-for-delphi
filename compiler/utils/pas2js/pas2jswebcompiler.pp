...
Type
  ...
  Protected
    function DoWriteJSFile(const DestFilename, MapFilename{!![Kryvich]}: String; aWriter: TPas2JSMapper): Boolean; override;
...
function TPas2JSWebcompiler.DoWriteJSFile(const DestFilename, MapFilename: String; aWriter: TPas2JSMapper): Boolean;
