...
Type
  ...
  TFPHashObjectList = TFPDictionary<TJSONData>;
  ...
  public
    ...
    {$ELSE}
    function Add(I : NativeInt): Integer; overload;
    {$ENDIF}
...
{$ELSE}
    ...
    function BufferHexToInt(P : PChar): integer;
    var
      N, i: integer;
      ch: char;
    begin
...
begin
  ...
  else if not Assigned(JPSH) then
...
{$else}
begin
  FHash.AddOrSetValue(AName, AValue); // Will free the previous value.
end;
{$ENDIF}
